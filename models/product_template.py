    ...
    def init(self):
        ...
        for doc in docs_rfq:
            ...
            if doc.warehouse_id.name == 'Toko TAS':
                product.type_rule_store = 'rfq'
                product.stock_min_in_store = doc.product_min_qty
                product.stock_max_in_store = doc.product_max_qty

            if doc.warehouse_id.name == 'Gudang TAS':
                product.stock_min_in_warehouse = doc.product_min_qty
                product.stock_max_in_warehouse = doc.product_max_qty            
